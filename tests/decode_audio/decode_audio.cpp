...
public:
  RawAudioFileSink(const char *fileName) { file = fopen(fileName, "wb"); }
...
int main() {
  // This example will decode an audio stream from a container and output it as
  // raw audio data in the chosen format.
  try {
